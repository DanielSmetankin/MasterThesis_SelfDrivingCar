...
R           = 10000;      % Radius of curvature for the road      (m)
...
m       = 3;     % Total mass of vehicle                          (kg)
Iz      = 0.0175;     % Yaw moment of inertia of vehicle               (m*N*s^2)
lf      = 0.16;      % Longitudinal distance from c.g. to front tires (m)
lr      = 0.15;      % Longitudinal distance from c.g. to rear tires  (m)
Cf      = 0.18;    % Cornering stiffness of front tires             (N/rad)
Cr      = 0.16;    % Cornering stiffness of rear tires              (N/rad)
tau     = 0.5;      % Longitudinal time constant                     (N/A)

% Initial condition for the ego car
v0_ego = 0.1;         % Initial speed of the ego car           (m/s)
...
yawerr_gain     = 1.5;    % Yaw error gain                        (N/A)
