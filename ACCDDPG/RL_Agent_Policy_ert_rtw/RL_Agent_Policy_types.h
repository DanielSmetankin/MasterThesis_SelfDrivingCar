...
//
#ifndef RTW_HEADER_RL_Agent_Policy_types_h_
#define RTW_HEADER_RL_Agent_Policy_types_h_
#include "rtwtypes.h"

// Custom Type definition for MATLAB Function: '<S1>/PolicyWrapper'
#ifndef struct_cell_wrap_22_RL_Agent_Policy_T
#define struct_cell_wrap_22_RL_Agent_Policy_T

struct cell_wrap_22_RL_Agent_Policy_T
{
  real32_T f1[48];
};

#endif                                 // struct_cell_wrap_22_RL_Agent_Policy_T

#ifndef struct_dlarray_1_RL_Agent_Policy_T
#define struct_dlarray_1_RL_Agent_Policy_T

struct dlarray_1_RL_Agent_Policy_T
{
  real32_T Data;
};

#endif                                 // struct_dlarray_1_RL_Agent_Policy_T
...
#endif                                 // RTW_HEADER_RL_Agent_Policy_types_h_
